...
// </copyright>
// <author></author>
// <date>1/17/2023 8:46:31 AM</date>
...
namespace HSO.Plugins
{
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        /// </summary>
        /// <param name="pluginClassName">The of the derived class.</param>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "PluginBase")]
    ...
    {
        /// <summary>
        /// The PowerApps CDS organization service for calling user account
        /// </summary>
        IOrganizationService CallingUserService { get; }
        ...
        /// <summary>
        /// Provided logging run-time trace information for plug-ins in application insights
        /// </summary>
        ILogger Logger { get; }
        /// <summary>
        /// Writes a trace message to the CDS trace log 
        /// </summary>
        /// <param name="message"> custom message that needs to be traced.</param>
    ...
    public class LocalPluginContext : ILocalPluginContext
    {
        ...
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "LocalPluginContext")]
        public IOrganizationService CallingUserService { get; private set; }
        ...
        public LocalPluginContext(IServiceProvider serviceProvider)
        {
            ...
            //Obtain the logger from service provider
            Logger = (ILogger)serviceProvider.GetService(typeof(ILogger));

            // Use the factory to generate the organization service.
            CallingUserService = factory.CreateOrganizationService(PluginExecutionContext.UserId);
