...
namespace HSO.Plugins
{
	...
	public partial class DataverseContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="HSO.Plugins.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<HSO.Plugins.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<HSO.Plugins.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="HSO.Plugins.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<HSO.Plugins.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<HSO.Plugins.Contact>();
			}
		}
	}
